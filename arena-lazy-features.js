(() => {
  ...
  const BUNDLES = Object.freeze({
    ...
    champions: [
      './champion-banners.js?v=20260919-2',
      './ranking-campeoes.js?v=20260815-1',
      './arena-champion-publish.js?v=20260919-2'
    ],
    registrations: [
    ...
    flash: [
      './flash-cup-draw-engine.js?v=20260822-10',
      './flash-cup-knockout-engine.js?v=20260822-10',
      './copas-flash.js?v=20260822-10'
    ],
    feedback: [
