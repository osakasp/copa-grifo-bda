...
const SHELL = ['./', './index.html', './preview-v2.html', './favicon.svg', './site.webmanifest', './arena-pro-motion.js?v=20260818-1', './super-league-runtime-fix.js?v=20260818-1'];
...
self.addEventListener('fetch', event => {
  ...
  const isCriticalArenaScript = sameOrigin
    ...
    && /\/(super-league-guard|super-league-runtime-fix)\.js$/.test(url.pathname);
