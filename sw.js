const VERSION = 'v105-admin-team-editor';
...
const CLEANUP_SRC = './arena-v3-cleanup.js?v=20260821-5';
...
self.addEventListener('fetch', event => {
  ...
  const isCriticalArenaScript = request.destination === 'script'
    && /\/(firebase-auth|firestore-sync|classificacao-automatica|arena-v3-cleanup|arena-redesign-v1|arena-mobile-polish|arena-mobile-bracket-v3|arena-team-editor|super-league-guard|super-league-runtime-fix|super-league-repechage|super-league-schedule-repair|bda-logo|arena-home-active)\.js$/.test(url.pathname);
