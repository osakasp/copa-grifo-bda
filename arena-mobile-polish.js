(() => {
  ...
  function installStyles() {
    ...
    style.textContent = `
      ...
      .arena-zone-legend .direct i{background:#4fdf8f}
      .arena-zone-legend .repechage i{background:#d8b248}
      .arena-zone-legend .qualified i{background:#4fdf8f}

      @media(max-width:760px){
        :root{
          --arena-mobile-nav-space:108px;
          --arena-context-accent:#d8b248!important;
          --arena-context-rgb:216,178,72!important;
          --arena-context-soft:#f1d97f!important;
        }

        html{scroll-padding-bottom:var(--arena-mobile-nav-space)}
        body.arena-visual-system{
          --arena-accent:#d8b248!important;
          --arena-accent-rgb:216,178,72!important;
          --arena-gold:#d8b248!important;
          --arena-gold-soft:#f1d97f!important;
          --green:#4fdf8f!important;
          padding-bottom:var(--arena-mobile-nav-space)!important;
          background:#030805!important;
        }
        body.arena-visual-system main{
          padding:10px 10px var(--arena-mobile-nav-space)!important;
        }
        ...
        body.arena-visual-system .brand-mark{
          ...
          border:1px solid rgba(216,178,72,.30)!important;
          border-radius:10px!important;
        }
        body.arena-visual-system .brand-copy strong{
          font-size:18px!important;
          letter-spacing:.02em!important;
        }
        body.arena-visual-system .brand-copy span{display:none!important}
        body.arena-visual-system .top-actions{
          gap:5px!important;
          min-width:0;
          margin-left:auto;
        }
        body.arena-visual-system .top-actions > :is(button,a){
        ...
        body.arena-visual-system #adminBtn{
          font-size:0!important;
          color:#f1d97f!important;
          background:#0a1710!important;
        }
        body.arena-visual-system #adminBtn::before{content:'⚙';font-size:17px;line-height:1}
        body.arena-visual-system #adminBtn.active{
          color:#101309!important;
          background:#d8b248!important;
        }
        body.arena-visual-system #memberLogoutBtn{
          font-size:0!important;
        }
        body.arena-visual-system #memberLogoutBtn::before{content:'↪';font-size:17px;line-height:1}

        [data-page="home"].active{
        ...
        [data-page="home"] .quick-stats{
          order:3!important;
          grid-template-columns:repeat(3,minmax(0,1fr))!important;
          gap:6px!important;
          margin:12px 0 0!important;
        }
        [data-page="home"] .quick-stats .stat{
          min-height:64px!important;
          padding:9px 7px!important;
          border-radius:10px!important;
          background:#08130c!important;
        }
        [data-page="home"] .quick-stats .stat b{font-size:21px!important}
        [data-page="home"] .quick-stats .stat span{
        ...
        .bottom-nav,.arena-mobile-nav{
          ...
          border-color:rgba(216,178,72,.16)!important;
          background:rgba(3,12,7,.98)!important;
          box-shadow:0 -10px 28px rgba(0,0,0,.34)!important;
          backdrop-filter:blur(14px)!important;
          -webkit-backdrop-filter:blur(14px)!important;
        }
        .bottom-nav .nav-btn,.arena-mobile-nav button{
          min-height:52px!important;
          border-radius:10px!important;
          color:#91a197!important;
          background:transparent!important;
        }
        .bottom-nav .nav-btn.active,.arena-mobile-nav button.active{
          color:#f1d97f!important;
          background:#0c2516!important;
          box-shadow:inset 0 2px 0 #d8b248!important;
        }
        .bottom-nav .nav-btn i,.arena-mobile-nav button i{font-size:19px!important}

        #autoStandings .stand-head{
          display:grid!important;
        ...
        #autoStandings .stand-head h2{
          margin:2px 0!important;
          font-size:23px!important;
          text-transform:none!important;
        }
        #autoStandings .stand-head p{font-size:9px!important;line-height:1.45!important}
        #autoStandings .stand-head button{
          justify-self:start!important;
          min-height:34px!important;
          padding:0 10px!important;
          font-size:9px!important;
        }
        #autoStandings .stand-highlights{
          grid-template-columns:1fr!important;
          gap:6px!important;
        }
        #autoStandings .stand-highlights article{
          display:grid!important;
        ...
        #autoStandings .stand-group>header{
          align-items:center!important;
          padding:10px!important;
          background:#0b2415!important;
        }
        #autoStandings .stand-group h3{
          margin:2px 0 0!important;
          color:#f4f6f4!important;
          font-size:20px!important;
          text-transform:none!important;
        }
        #autoStandings .stand-group>header>span{
          max-width:150px;
          color:#91a197!important;
          font-size:7px!important;
          line-height:1.35;
        ...
        #autoStandings th[data-mobile-key="rank"],
        #autoStandings td[data-mobile-key="rank"]{width:38px!important}
        #autoStandings th[data-mobile-key="club"],
        #autoStandings td[data-mobile-key="club"]{width:auto!important;text-align:left!important}
        #autoStandings th[data-mobile-key="pts"],
        #autoStandings td[data-mobile-key="pts"]{width:42px!important}
        #autoStandings th[data-mobile-key="j"],
        #autoStandings td[data-mobile-key="j"]{width:34px!important}
        #autoStandings th[data-mobile-key="sg"],
        #autoStandings td[data-mobile-key="sg"]{width:42px!important}
        #autoStandings th[data-mobile-key="group"],
        #autoStandings td[data-mobile-key="group"]{width:48px!important}
        #autoStandings .stand-club{gap:7px!important;min-width:0}
        #autoStandings .stand-badge{
          width:36px!important;
          height:36px!important;
        ...
        #autoStandings tr[data-zone="direct"] .stand-pos{
          color:#041108!important;
          background:#4fdf8f!important;
        }
        #autoStandings tr[data-zone="repechage"] .stand-pos{
          color:#171207!important;
          background:#d8b248!important;
        }
        #autoStandings tr[data-zone="qualified"] .stand-pos{
          color:#041108!important;
          background:#4fdf8f!important;
        }
        #autoStandings tr[data-zone="out"] .stand-pos{
        ...
        #giManager[data-tid="bda-super-league"] #autoStandings tr[data-zone="direct"] .stand-club span::after,
        #giManager[data-tid="bda-super-league"] #autoStandings tr[data-zone="repechage"] .stand-club span::after,
        #giManager[data-tid="bda-super-league"] #autoStandings tr[data-zone="out"] .stand-club span::after{
          display:block;
          margin-top:3px;
          font-size:7px;
          font-weight:800;
        ...
        #autoStandings .arena-mobile-stat-detail td{
        ...
        #superLeagueThirdPlaceRanking th[data-mobile-key="group"],
        #superLeagueThirdPlaceRanking td[data-mobile-key="group"]{display:table-cell!important}

        .gi-head>div:last-child,
        .pro-admin-bar,
        .admin-tools{
          scrollbar-width:none;
        }
        .gi-head>div:last-child::-webkit-scrollbar,
        .pro-admin-bar::-webkit-scrollbar,
        .admin-tools::-webkit-scrollbar{display:none}
        #giManager .gi-head>div:last-child :is(button,a),
        .pro-admin-bar :is(button,a){
          min-height:34px!important;
          padding:0 10px!important;
  ...
  function ensureLegend(manager) {
    ...
    const id = String(manager.dataset.tid || '');
    ...
    legend.innerHTML = id === SUPER_LEAGUE_ID
  ...
  window.ArenaBDAMobilePolish = Object.freeze({
    version: 1,
    refresh,
    decorateStandings,
    syncNavSpace
