(() => {
  ...
  const stages = [
    ...
    { number: 4, title: 'Copa Francos', subtitle: 'Regularidade ao longo de toda a disputa', competitions: [{ icon: '🕊️', name: 'Copa Francos', mode: 'Full Livre', format: 'Pontos corridos', audience: 'Todos os jogadores', rule: 'Os 6 melhores garantem vaga na Copa BDA.', tone: 'francos' }] },
    { number: 5, title: 'Copa BDA', subtitle: 'A copa dos melhores classificados', competitions: [{ icon: '🏆', name: 'Copa BDA', mode: 'Full Livre', format: 'Formato a confirmar', audience: '6 melhores da Copa Grifo + 6 melhores da Copa Francos', rule: 'Doze classificados disputam a competição.', tone: 'cup' }] },
  ...
  function build() {
    ...
    page.innerHTML = `<header class="season-hero"><div><span class="eyebrow">Calendário competitivo oficial</span><h1>Temporada BDA</h1><p>Seis etapas conectadas. Acesso, rebaixamento, classificação e títulos formam uma única jornada competitiva.</p><div class="season-hero-actions"><button class="primary" type="button" data-season-start>Ver primeira etapa</button><button class="secondary" type="button" data-go="tournament">Campeonatos atuais</button></div></div><aside><strong>6</strong><span>etapas</span><b>7 competições</b><small>Full Razz e Full Livre</small></aside></header>
      <section class="season-flow" aria-label="Fluxo da temporada"><span>Ligas A/B</span><i>→</i><span>Supercopa</span><i>→</i><span>Grifo</span><i>→</i><span>Francos</span><i>→</i><span>Copa BDA</span><i>→</i><span>Super League</span></section>
      <div class="season-stages">${stages.map(stageCard).join('')}</div>
      <section class="season-rules"><div><span class="eyebrow">Regras estruturais</span><h2>Como a temporada se conecta</h2></div><ul><li><b>Promoção:</b> quatro jogadores sobem da Liga B para a Liga A.</li><li><b>Rebaixamento:</b> quatro jogadores descem da Liga A para a Liga B.</li><li><b>Supercopa:</b> reúne os quatro melhores de cada divisão.</li><li><b>Copa BDA:</b> recebe seis classificados da Grifo e seis da Francos.</li><li><b>Super League:</b> dois classificados por grupo avançam ao mata-mata.</li></ul><p>Quantidade de grupos e participantes da Super League, além dos formatos da Supercopa e da Copa BDA, aguardam confirmação da organização.</p></section>`;
    return true;
  }
