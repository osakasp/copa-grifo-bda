(() => {
  ...
  const stages = [
    ...
    { number: 2, title: 'Copa Grifo', subtitle: 'A competição eliminatória aberta', competitions: [{ icon: '🦅', name: 'Copa Grifo', mode: 'Full Livre', format: 'Mata-mata', audience: 'Todos os jogadores', rule: 'Os 6 melhores garantem vaga na Copa BDA.', tone: 'griffin' }] },
    { number: 3, title: 'Copa Francos', subtitle: 'Regularidade ao longo de toda a disputa', competitions: [{ icon: '🕊️', name: 'Copa Francos', mode: 'Full Livre', format: 'Pontos corridos', audience: 'Todos os jogadores', rule: 'Os 6 melhores garantem vaga na Copa BDA.', tone: 'francos' }] },
    { number: 4, title: 'Copa BDA', subtitle: 'A copa dos melhores classificados', competitions: [{ icon: '🏆', name: 'Copa BDA', mode: 'Full Livre', format: 'Formato a confirmar', audience: '6 melhores da Copa Grifo + 6 melhores da Copa Francos', rule: 'Doze classificados disputam a competição.', tone: 'cup' }] },
    { number: 5, title: 'BDA Super League', subtitle: 'O encerramento de elite da temporada', competitions: [{ icon: '🌟', name: 'BDA Super League', mode: 'Full Razz', format: 'Grupos + mata-mata', audience: '21 clubes em quatro grupos', rule: 'Os 2 melhores de cada grupo avançam diretamente às quartas de final.', tone: 'finale' }] }
  ];
  ...
  function build() {
    ...
    page.innerHTML = `<header class="season-hero"><div><span class="eyebrow">Calendário competitivo oficial</span><h1>Temporada BDA</h1><p>Cinco etapas conectadas. Acesso, rebaixamento, classificação e títulos formam uma única jornada competitiva.</p><div class="season-hero-actions"><button class="primary" type="button" data-season-start>Ver primeira etapa</button><button class="secondary" type="button" data-go="tournament">Campeonatos atuais</button></div></div><aside><strong>5</strong><span>etapas</span><b>6 competições</b><small>Full Razz e Full Livre</small></aside></header>
      <section class="season-flow" aria-label="Fluxo da temporada"><span>Ligas A/B</span><i>→</i><span>Grifo</span><i>→</i><span>Francos</span><i>→</i><span>Copa BDA</span><i>→</i><span>Super League</span></section>
      <div class="season-stages">${stages.map(stageCard).join('')}</div>
      <section class="season-rules"><div><span class="eyebrow">Regras estruturais</span><h2>Como a temporada se conecta</h2></div><ul><li><b>Promoção:</b> quatro jogadores sobem da Liga B para a Liga A.</li><li><b>Rebaixamento:</b> quatro jogadores descem da Liga A para a Liga B.</li><li><b>Copa BDA:</b> recebe seis classificados da Grifo e seis da Francos.</li><li><b>Super League:</b> os dois melhores de cada grupo avançam diretamente às quartas de final.</li></ul><p>O formato da próxima Copa BDA aguarda confirmação da organização.</p></section>`;
    return true;
  }
