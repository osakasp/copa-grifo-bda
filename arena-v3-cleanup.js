(() => {
  ...
  if (window.ArenaBDAV3Cleanup?.version >= 28) return;
  ...
  const TEAM_CLOUD_SYNC_SRC = './arena-team-cloud-sync.js?v=20260906-3';
  ...
  function removeLegacySuperLeagueArtifacts() {
    ['superLeagueSecondPlaceRanking','superLeagueThirdPlaceRanking','superLeagueRepechageStyles','superLeagueRuleV3Styles']
  ...
  function ensureProvisionalKnockoutModule() {
    ensureScript({ globalName:'ArenaBDAProvisionalKnockout', selector:'script[data-arena-provisional-knockout]', src:PROVISIONAL_KNOCKOUT_SRC, datasetName:'arenaProvisionalKnockout', label:'as vagas confirmadas das eliminatórias', minVersion:4 });
  }
  ...
  function ensureTeamCloudSyncModule() {
    ensureScript({ globalName:'ArenaBDATeamCloudSync', selector:'script[data-arena-team-cloud-sync]', src:TEAM_CLOUD_SYNC_SRC, datasetName:'arenaTeamCloudSync', label:'a sincronização e os recursos atuais dos campeonatos', minVersion:10 });
  }
