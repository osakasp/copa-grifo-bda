(() => {
  ...
  function ensureSuperLeagueSyncModule() {
    ensureScript({ globalName:'ArenaBDASuperLeagueSyncGate', selector:'script[data-arena-super-league-sync-gate]', src:SUPER_LEAGUE_SYNC_SRC, datasetName:'arenaSuperLeagueSyncGate', label:'a sincronização entre aparelhos da Super League', minVersion:3 });
  }
