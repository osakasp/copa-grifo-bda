(() => {
  ...
  if (window.ArenaBDAV3Cleanup?.version >= 27) return;
  ...
  const TEAM_CLOUD_SYNC_SRC = './arena-team-cloud-sync.js?v=20260906-2';
  ...
  function ensureTeamCloudSyncModule() {
    ensureScript({ globalName:'ArenaBDATeamCloudSync', selector:'script[data-arena-team-cloud-sync]', src:TEAM_CLOUD_SYNC_SRC, datasetName:'arenaTeamCloudSync', label:'a sincronização e os recursos atuais dos campeonatos', minVersion:9 });
  }
